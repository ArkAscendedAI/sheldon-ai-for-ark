...
### Test
- Mod testing across maps and server configurations
...
Changes to the permission system (the tool registry, tiers, sessions, or auth) require:
...
If you find a security vulnerability in the permission system, **do not open a public issue**. Report it privately (see [SECURITY.md](SECURITY.md)) so the fix can be developed before disclosure.
