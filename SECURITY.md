...
The permission model is documented in [docs/PERMISSIONS.md](docs/PERMISSIONS.md). The LLM is treated as an untrusted component, and all enforcement happens in deterministic code.
